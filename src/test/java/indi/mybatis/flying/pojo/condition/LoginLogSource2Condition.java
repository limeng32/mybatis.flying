...
public class LoginLogSource2Condition extends LoginLogSource2 implements Conditionable {
	...
	@Or({ @ConditionMapperAnnotation(dbFieldName = "accountId", conditionType = ConditionType.Equal, customTypeHandler = org.apache.ibatis.type.LongTypeHandler.class),
			@ConditionMapperAnnotation(dbFieldName = "accountId", conditionType = ConditionType.Equal, customTypeHandler = org.apache.ibatis.type.LongTypeHandler.class) })
