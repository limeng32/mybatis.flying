...
/**
 * The SQL statement is automatically generated by intercepting the
 * StatementHandler's prepare method, according to the annotation information
 * configured by the parameter parameterObject.
 */
@Intercepts({
