 ...
 *              generated by all queries from MyBatis. When an update or delete
 *              operation is executed, the associated cache is removed according
 *              to the state corresponding to this operation.
 */
public interface EnhancedCachingManager {
	...
	/**
	 * @param properties Properties contain at least two
	 *                   properties:annotationPackage and cacheEnabled.
	 * 
	 *                   annotationPackage: the package name where the
	 *                   pojomapper.java file is located, and multiple packages can
	 *                   be separated by English commas.
	 * 
	 *                   cacheEnbled: "true" or "false", indicates whether the cache
	 *                   is used.
	 */
	 ...
	 * 
	 * @param sessionCacheKeysPool CacheKeysPool
	 */
	 ...
	 * statementId configured the dependencies, if any, will remove the query cache.
	 * 
	 * @param set Set
	 */
	...
	/**
	 * If MyBatis opens the second level Cache, and the query StatementId USES the
	 * second level Cache, and the corresponding Mapper configuration Cache, this
	 * StatementId and Cache in the form of key-value pairs stored in the global
	 * Cache manager.
	 * 
